...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/icons-425-blue?style=flat-square" alt="Icons Count">
...
> 仓库内全部图标已完成规范化：**425 / 425 均为 512×512 圆角矩形（r≈99px、保留原始底色）**，经 `scripts/optimize-icons.py` 无损重压缩。处理明细与遗留项见 [`docs/references/icon-quality-notes.md`](docs/references/icon-quality-notes.md)。
