...
|---|---|
| [Surge](https://nssurge.com) (iOS / Mac) | `icon-url=` |
| [Clash Meta / Mihomo](https://github.com/MetaCubeX/mihomo) | `icon:` |
| [Loon](https://www.loon0.com) | `icon=` |
| [Stash](https://stash.wiki) | `icon:` |
...
`1Password.png`, `AdGuard.png`, `Cloudflare.png`, `Duolingo-1.png` ~ `-2.png`, `GitHub-1.png` ~ `-2.png`, `Keep.png`, `Notion.png`, `Oracle.png`, `SF-Express.png`, `Speedtest-1.png` ~ `-2.png`, `TMDB.png`, `Z-Library.png`
...
| 项目 | 描述 |
|:---|---|
| [Koolson/Qure](https://github.com/Koolson/Qure) | Quantumult X 策略组图标集（标杆项目） |
